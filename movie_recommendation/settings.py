...
SECRET_KEY = 'django-insecure-7o!^m$&+5xb(sjamh=%+gvel=bw)ishl5@k29i62ec*1(26d70'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'Movie',  # Tên cơ sở dữ liệu trong MongoDB
        'ENFORCE_SCHEMA': False,  # Không yêu cầu schema khi lưu vào MongoDB
        'CLIENT': {
            'host': 'mongodb://localhost:27017/',  # Kết nối tới MongoDB
        'authSource': 'admin',
        }
    }
}
...
LOGIN_REDIRECT_URL = '/'  # Chuyển hướng tới trang dành cho user/admin sau khi đăng nhập
